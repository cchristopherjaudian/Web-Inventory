        ...
        <Grid container sx={{pt:2}}>
            {
                ...
                :
                activeStep === 2 ?
                <Confirmation paymentUrl = {orderInfo['paymentUrl']} incrementStep={incrementStep} id={orderInfo['id']} method={orderInfo['paymentMethod']} status={orderInfo['orderStatus']} mainStatus = {orderInfo['status']}/>
                :
