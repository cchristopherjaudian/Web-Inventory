...
const Invoice = (props) => {
    ...
    return (
        <Grid container spacing={1} sx={{ pl: 3, pt: 5 }}>
            {
                props.orderInfo['status'] === 'PROCESSING' ?
                    <>
                        <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'center', mt: 2 }}>
                            <Typography variant="h1">Your order/payment is still being processed</Typography>
                        </Grid>
                        <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'center' }}>
                            <Typography variant="h5">Invoice will appear after payment validation</Typography>
                        </Grid>
                    </>
                    :
                    <>
                        <Grid container>
                            ...
                            <Grid item xs={12} md={6}>
                                ...
                                <Typography variant="h4" sx={{ mt: 2 }}>Number {props.orderInfo['id']}</Typography>
                        ...
                        <Grid container sx={{ mt: 2 }}>
                            <Grid item xs={12} md={6}>
                                <Typography variant="h3" sx={{ pl: 4 }}>From</Typography>
                                <Typography variant="h5" sx={{ pl: 4, mt: 3 }}>Oxiaire Gas Enterprises</Typography>
                                <Typography variant="h5" sx={{ pl: 4 }}>Plant: 1576 Maharlika Highway</Typography>
                                <Typography variant="h5" sx={{ pl: 4 }}>Office: 1260 Maharlika Highway, Isabang, Lucena City</Typography>
                                <Typography variant="h5" sx={{ pl: 4 }}>Tax NUmber: 100090757</Typography>
                            </Grid>
                            <Grid item xs={12} md={6}>
                                <Grid container>
                                    <Grid item xs={9}>
                                        ...
                                        <TableBody>
                                            {
                                                ...
                                                props.orderInfo['orderItems']?.length > 0 && props.orderInfo['orderItems']?.map((cart, index) => {
                                                    console.log(cart);
                                                    return <TableRow
                                                        key={1}
