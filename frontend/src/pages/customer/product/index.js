          ...
          <Card mt={2} sx={{ width: '100%', display: 'flex', padding: 2 }}>
            <Box sx={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <Typography variant="body1" mt={1}>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae sem a tortor luctus molestie at nec nunc. Mauris
                scelerisque laoreet purus at malesuada. Sed eleifend tincidunt lobortis. Phasellus et quam facilisis neque suscipit iaculis.
                Vivamus tempus dui vitae lobortis tincidunt. Pellentesque dictum massa sit amet felis vehicula, nec mattis massa facilisis.
                Cras quis orci vel tortor elementum sagittis. Aliquam tempor augue vel purus iaculis, posuere ultricies augue laoreet. Donec
                convallis nisi elit, tristique molestie dui rhoncus eu. Mauris sagittis nec risus at feugiat. Integer pulvinar nunc non nisl
                semper, pulvinar posuere risus molestie. Suspendisse potenti. Fusce efficitur rutrum felis vitae pharetra. Curabitur
                vulputate lectus sit amet posuere lobortis.
              </Typography>
            </Box>
          </Card>
        </Grid>
