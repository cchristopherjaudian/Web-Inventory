...
const Options = (props) => {
  ...
  return (
    <Grid container mt={3} spacing={5} sx={{ display: 'flex', justifyContent: 'space-between' }}>
      ...
      <Grid item xs={12} md={4}>
        <Button
          ...
          color="primary"
          fullWidth
          onClick={() => navigate('/purchase/order/' + props.quoteInfo.groupNo, { replace: true })}
        >
