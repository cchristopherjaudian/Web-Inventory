...
const Acknowledge = (props) => {
    ...
    return (<MainCard>
        <Grid container spacing={1} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Grid item xs={12} container spacing={1} sx={{mt:3, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Grid item xs={12} mt={3} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }} gap={2}>
                ...
                <Button variant="contained" color="primary" onClick={() => navigate('/order/' + props.orderId, { replace: true })}>
                    View Order
                </Button>
            </Grid>
        </Grid>
