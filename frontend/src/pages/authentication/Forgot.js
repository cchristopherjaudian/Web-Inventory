                    ...
                    <div id='recaptcha-container'></div>
                    {
                        isVerified ?
                            <>
                                ...
                                <Button variant="contained" sx={{ mt: 3 }} fullWidth onClick={processChange}>Update Password</Button>
                            ...
                            (
                                isWaiting ?
                                    ...
                                    <>
                                        ...
                                        <Button variant="contained" sx={{ mt: 3 }} fullWidth onClick={onSignUp}>Send OTP</Button>
                                        <Button variant="outlined" sx={{ mt: 1 }} fullWidth onClick={() => navigate('/')}>Cancel</Button>
                                    </>
                            )
                    }
